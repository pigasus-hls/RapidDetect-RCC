...
const std::unordered_map<std::string, register_info_t> dcmac_registers = {
    ...
    {"CONFIGURATION_EMPTY0", {0x0018, RW, {{"ctl_rsvd0", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY1", {0x001C, RW, {{"ctl_rsvd1", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY2", {0x0020, RW, {{"ctl_rsvd2", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY3", {0x0024, RW, {{"ctl_rsvd3", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY4", {0x0028, RW, {{"ctl_rsvd4", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY5", {0x002C, RW, {{"ctl_rsvd5", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY6", {0x0030, RW, {{"ctl_rsvd6", {0, 32, 0, RW}}}}},
    {"CONFIGURATION_EMPTY7", {0x0034, RW, {{"ctl_rsvd7", {0, 32, 0, RW}}}}},
    ...
    {"MAC_CONFIG_REG_TX_RD", {0x003C, RW, {{"mac_tx_cfg_data_rd", {0, 8, 0, RW}}}}},
    ...
    {"ALL_CHANNEL_MAC_TICK_REG_RX", {0x00F4, RW, {{"rx_all_channel_mac_soft_pm_tick", {0, 1, 0, RW}}}}},
    ...
    {"ALL_CHANNEL_MAC_TICK_REG_TX", {0x00FC, RW, {{"rx_all_channel_mac_soft_pm_tick", {0, 1, 0, RW}}}}},
    {"STAT_TX_ECC_ERR_REG",
     {0x01B0,
      RO,
    ...
    {"C0_CHANNEL_CONTROL_REG_RX", {0x1030, RW, {{"c0_soft_rx_mac_channel_flush", {0, 1, 0, RW}}}}},
    {"C0_CHANNEL_CONTROL_REG_TX", {0x1038, RW, {{"c0_soft_tx_mac_channel_flush", {0, 1, 0, RW}}}}},
    {"C0_TX_MODE_REG",
     {0x1040,
      RW,
    ...
    {"C0_RX_FEC_SLICE_CONFIGURATION1", {0x1048, RW, {{"c0_ctl_rx_degrade_interval", {0, 32, 0, RW}}}}},
    {"C0_RX_FEC_SLICE_CONFIGURATION2", {0x104C, RW, {{"c0_ctl_rx_degrade_act_thresh", {0, 32, 0, RW}}}}},
    {"C0_RX_FEC_SLICE_CONFIGURATION3", {0x1050, RW, {{"c0_ctl_rx_degrade_deact_thresh", {0, 32, 0, RW}}}}},
    {"C0_CONFIGURATION_RX",
     {0x10A0, RW, {{"c0_ctl_rx_flexif_select", {0, 2, 1, RW}}, {"c0_ctl_rx_flexif_pcs_wide_mode", {2, 1, 0, RW}}}}},
    {"C0_PORT_CONTROL_REG_RX",
     {0x10F0, RW, {{"c0_soft_rx_flexif_reset", {0, 1, 0, RW}}, {"c0_soft_rx_serdes_reset", {1, 1, 0, RW}}}}},
    {"C0_PORT_TICK_REG_RX", {0x10F4, RW, {{"c0_rx_port_soft_pm_tick", {0, 1, 1, RW}}}}},
    {"C0_PORT_CONTROL_REG_TX",
     {0x10F8, RW, {{"c0_soft_tx_flexif_reset", {0, 1, 1, RW}}, {"c0_soft_tx_serdes_reset", {1, 1, 0, RW}}}}},
    {"C0_PORT_TICK_REG_TX", {0x10FC, RW, {{"c0_tx_port_soft_pm_tick", {0, 1, 1, RW}}}}},
    ...
    {"C0_STAT_CHAN_TX_MAC_RT_STATUS_REG",
     {0x1104,
      ...
      {{"c0_stat_tx_local_fault", {0, 1, 0, RO}},
       ...
       {"c0_stat_tx_packet_small", {3, 1, 0, RO}},
       {"c0_stat_tx_sic_overflow", {4, 1, 0, RO}}}}},
    {"C0_STAT_CHAN_TX_STATISTICS_READY", {0x1108, RO, {{"c0_stat_tx_channel_mac_statistics_ready", {0, 1, 1, RO}}}}},
    ...
    {"C0_STAT_CHAN_RX_MAC_RT_STATUS_REG",
     {0x1144,
      ...
      {{"c0_stat_rx_remote_fault", {0, 1, 0, RO}},
       ...
       {"c0_stat_rx_invalid_start", {7, 1, 0, RO}},
       {"c0_stat_rx_bad_code", {8, 1, 0, RO}}}}},
    {"C0_STAT_CHAN_RX_STATISTICS_READY", {0x1148, RO, {{"c0_stat_tx_channel_mac_statistics_ready", {0, 1, 1, RO}}}}},
    {"C0_STAT_PORT_TX_MAC_STATUS_REG",
     {0x1180, RO, {{"c0_stat_tx_axis_unf", {0, 1, 0, RO}}, {"c0_stat_tx_axis_err", {0, 1, 0, RO}}}}},
    {"C0_STAT_PORT_TX_MAC_RT_STATUS_REG",
     {0x1184, RO, {{"c0_stat_tx_axis_unf", {0, 1, 0, RO}}, {"c0_stat_tx_axis_err", {0, 1, 0, RO}}}}},
